...
/* Let's refactor for abstraction  
    ...
    1. Take a look to ParseTrades method, the validation section could refactor as  ValidateTradeData. Note, you should comment the continue keyword and add 
       a if conditional to keep the same behavior, something like  
        ValidateTradeData(string[] fields, int lineCount);
